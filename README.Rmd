...
```{r plot seasonnal 365 amb.multi, echo = FALSE, eval = TRUE}
# P = 365
plot.new()
rect(xleft = par("usr")[1], xright = par("usr")[2], 
     ytop = par("usr")[4], ybottom = par("usr")[3], col = col_bg)
...
Plot the comparison between the two AMB methods for the weekly periodicity:

```{r plot seasonnal 7 amb.multi, echo = FALSE, eval = TRUE}
#P = 7
plot.new()
rect(xleft = par("usr")[1], xright = par("usr")[2], 
     ytop = par("usr")[4], ybottom = par("usr")[3], col = col_bg)
...
plot(x = df_daily$date, y = df_daily$births, col = col_y, 
     type = "l", xlab = "Time", ylab = "Nb of french births", 
     main = "Decomposition")
lines(x = df_daily$date, y = amb.multi.sa, 
      type = "l", col = col_sa)
lines(x = df_daily$date, y = amb.multi.t, 
      type = "l", col = col_t)
